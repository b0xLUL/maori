...
spec_langs = ['am', 'ar', 'hy', 'be', 'bn', 'bg', 'zh-cn', 'zh-tw', 'ka', 'el', 'gu', 'he', 'hi', 'ig', 'ja', 'kn', 'kk', 'km', 'ko', 'ky', 'lo', 'my', 'ml', 'mn', 'mr', 'ml', 'ne', 'or', 'ps', 'fa', 'pa', 'ru', 'sr', 'sd', 'si', 'tg', 'ta', 'te', 'th', 'uk', 'ur', 'ug', 'yi']

# very special languages
# ver_spec_langs = ['zh-cn', 'zh-tw', 'ja', 'ko', 'or', 'ug', 'gu', 'ar', 'ps', 'my', '', '', '']
