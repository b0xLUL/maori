...
langs2 = ['am', 'ar', 'hy', 'be', 'bn', 'bg', 'zh-cn', 'zh-tw', 'ka', 'el', 'gu', 'he', 'hi', 'ig', 'ja', 'kn', 'kk', 'km', 'ko', 'ky', 'lo', 'ml', 'mn', 'mr', 'ml', 'ne', 'or', 'ps', 'fa', 'pa', 'ru', 'sr', 'sd', 'si', 'tg', 'ta', 'te', 'th', 'uk', 'ur', 'ug', 'yi']

# print(googletrans.LANGUAGES)

# vraag gebruiker om graad van vervorming
degree = int(input('\nGraad van vervorming: '))
...
for i in range(0, degree-1):
    time.sleep(3)
    random_lang = langs2[random.randint(0,len(langs2)-1)]
